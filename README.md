...
**148 unit tests** cover the IPP codec (request framing, multi-value and resolution decoding,
...
sensing and darkness commands for both label dialects. CI builds and tests both variants on every
push.
